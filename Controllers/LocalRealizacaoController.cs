...
namespace ProjetoFinalVinicius.Controllers
{
    public class LocalRealizacaoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LocalRealizacaoId,LocalRealizacaoNome,CidadeId")] LocalRealizacao localRealizacao)
        {
            ...
            ViewData["CidadeId"] = new SelectList(_context.Cidade, "CidadeId", "NomeCidade", localRealizacao.CidadeId);
            return View(localRealizacao);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocalRealizacaoId,LocalRealizacaoNome,CidadeId")] LocalRealizacao localRealizacao)
        {
            if (id != localRealizacao.LocalRealizacaoId)
            {
                return NotFound();
            }
