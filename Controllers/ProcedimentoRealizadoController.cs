...
namespace ProjetoFinalVinicius.Controllers
{
    public class ProcedimentoRealizadoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProcedimentoRealizadoId,ClienteId,ProcedimentoId,ColaboradorId,LocalRealizacaoId,DataRealizadoId,ObservacaoRealizadoId")] ProcedimentoRealizado procedimentoRealizado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProcedimentoRealizadoId,ClienteId,ProcedimentoId,ColaboradorId,LocalRealizacaoId,DataRealizadoId,ObservacaoRealizadoId")] ProcedimentoRealizado procedimentoRealizado)
        {
