...
namespace ProjetoFinalVinicius.Controllers
{
    public class TipoColaboradorController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TipoColaboradorId,TipoColaboradorNome")] TipoColaborador tipoColaborador)
        {
            if (id != tipoColaborador.TipoColaboradorId)
            {
                return NotFound();
            }
