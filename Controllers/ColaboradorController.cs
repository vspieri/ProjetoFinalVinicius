...
namespace ProjetoFinalVinicius.Controllers
{
    public class ColaboradorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ColaboradorId,ColaboradorNome,ColaboradorCpf,ColaboradorSexo,ColaboradorTelefone,CidadeId,TipoColaboradorId")] Colaborador colaborador)
        {
            ...
            ViewData["CidadeId"] = new SelectList(_context.Cidade, "CidadeId", "NomeCidade", colaborador.CidadeId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ColaboradorId,ColaboradorNome,ColaboradorCpf,ColaboradorSexo,ColaboradorTelefone,CidadeId,TipoColaboradorId")] Colaborador colaborador)
        {
